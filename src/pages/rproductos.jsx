                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="space-y-6">
                                <div className="flex flex-col space-y-4">
                                    ...
                                    <div className="w-full">
                                        <label className="block text-white mb-2" htmlFor="Administrador">Administrador</label>
                                        <input
                                            type="text"
                                            id="Administrador"
                                            value={Administrador}
                                    ...
                                    <div className="w-full">
                                        <label className="block text-white mb-2" htmlFor="Proveedor">Proveedor</label>
                                        <input
                                            type="text"
                                            id="Proveedor"
                                            value={Proveedor}
