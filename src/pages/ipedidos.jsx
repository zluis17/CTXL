...
const MiComponente = () => {
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 z-[-1] bg-[linear-gradient(to_right,_#0f0f10_1px,_transparent_1px),_linear-gradient(to_bottom,_#0f0f10_1px,_transparent_1px)] bg-[size:1rem_1rem] bg-center filter blur-sm"></div>
...
function IPedidos() {
  const [data, setData] = useState([
    ...
    { id: 2, producto: "Producto B", cantidad: 20 },
    { id: 3, producto: "Producto C", cantidad: 15 },
  ]);
      ...
      >
          ...
          <div className=" w-3/4 margin-top-20px">
            <div className="w-1/4 flex">
              <h1 className="white-space:nowrap text-4xl font-bold">Inventario Pedidos</h1>
          ...
          <div className="">
            ...
            <div>
              <a
                href="#settings"
                className="align-text-center block text-right text-3xl p-8 hover:text-purple-400"
              >
                Registrar Nuevo
              </a>
            </div>
            ...
            {/* Table */}
            <div className=" overflow-x-auto mx-auto w-full max-w-7xl">
              <table className=" w-full bg-black text-white border rounded-lg shadow-lg">
                ...
                <tbody>
                  {data.map((item) => (
                    <tr
                      key={item.id}
                      className="border-b border-purple-600 text-2xl"
                    >
